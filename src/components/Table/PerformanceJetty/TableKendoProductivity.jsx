...
import columns from "../dummyData/columnsProductivity";
...
const mergeCells = (data) => {
  ...
  for (let i = 0; i < data.data.length; i += looped) {
    ...
    for (let j = i + 1; j < data.data.length; j++) {
        //item in here is name header item
...
const TableKendoProductivity = ({dataTableProps, limitMinimumProps}) => {
...
export default TableKendoProductivity;