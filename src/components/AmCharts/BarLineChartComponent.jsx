...
function BarLineChartComponent({chartNameProps, chartDataProps, chartLineProps, categoryChartProps, dataTypeProps = ''}) {
  useLayoutEffect(() => {
      ...
      series2.bullets.push(function() {
        return am5.Bullet.new(root, {
          sprite: am5.Circle.new(root, {
            ...
            showTooltipOn: "always",
            tooltipText: "{valueY}" + dataTypeProps,
            tooltip: am5.Tooltip.new(root, {})
          })
        });
      });
  ...
  return (
    <div id={chartNameProps} style={{ width: "100%", height: "250px" }}></div>
  );
}
